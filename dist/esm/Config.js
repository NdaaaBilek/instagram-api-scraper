...
export const API_URL = (code) => `${BASE_URL}?query_hash=${HASH}&variables=${encodeURIComponent(`{"shortcode": "${code}","child_comment_count":3,"fetch_comment_count":40,"parent_comment_count":24,"has_threaded_comments":true}`)}`;
export const Config = {

...
exports.PARSER = exports.extractCode = exports.Config = exports.API_URL = void 0;
const BASE_URL = "https://www.instagram.com/graphql/query";
const HASH = "9f8827793ef34641b2fb195d4d41151c";
const API_URL = (code) => `${BASE_URL}?query_hash=${HASH}&variables=${encodeURIComponent(`{"shortcode": "${code}","child_comment_count":3,"fetch_comment_count":40,"parent_comment_count":24,"has_threaded_comments":true}`)}`;
exports.API_URL = API_URL;
exports.Config = {
    "user-agent": "Mozilla/5.0 (Linux; Android 13; M2007J20CG Build/TQ1A.221205.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.79 Mobile Safari/537.36",
...
const REGEXP = /(?:https?:\/\/www\.)?instagram\.com\/[\w]+\/(.*?)\//;
...
const PARSER = (arr) => {
    ...
    if (shortVar &&
        ...
        shortVar.edge_sidecar_to_children.edges.map((v) => {
